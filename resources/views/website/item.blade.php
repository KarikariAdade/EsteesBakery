        ...
        <section class="product_details_area">
        	<div class="container">
        		<div class="row product_d_price">
        			<div class="col-lg-6">
        				<div class="product_img"><img class="img-fluid shadow" src="{{ asset('images/cakes/5.jpg') }}" alt=""></div>
        			</div>
        			<div class="col-lg-6">
        				<div class="product_details_text">
        					...
        					<h5>Price: <span> Gh&cent 24.5</span> <small>Gh&cent 10 </small> </h5>
        					<div class="quantity_box">
        						<label for="quantity">Quantity :</label>
        						<input type="text" placeholder="1" id="quantity">
        					</div>
        					<button class="pest_btn order_btn btn" href="#">Add to Cart</button>
        				</div>
        			</div>
        		</div>
